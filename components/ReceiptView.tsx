...
const styles = StyleSheet.create({
  ...
  saleIdText: { fontSize: 11, fontWeight: '700' },
  ...
  sectionLabel: { fontSize: 9, fontWeight: '700', letterSpacing: 1.5, marginBottom: 6 },
  tableHeader: { flexDirection: 'row', paddingBottom: 6, borderBottomWidth: 1, borderBottomColor: '#E2E8F0', marginBottom: 4 },
  colHeader: { fontSize: 9, fontWeight: '700', letterSpacing: 0.5 },
  colProduct: { flex: 1.5 },
  ...
  itemName: { fontSize: 12, fontWeight: '600', lineHeight: 16 },
  itemQty: { fontSize: 12, fontWeight: '500' },
  itemPrice: { fontSize: 11, fontWeight: '500' },
  ...
  paymentValue: { fontSize: 12, fontWeight: '700' },
  accountInfo: { paddingHorizontal: 16, paddingVertical: 10, borderTopWidth: 1 },
  accountSectionTitle: { fontSize: 10, fontWeight: '700', letterSpacing: 1, marginBottom: 6 },
  accountRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 3 },
  accountLabel: { fontSize: 10, fontWeight: '500' },
  accountValue: { fontSize: 12, fontWeight: '600' },
  noAccountText: { fontSize: 11, textAlign: 'center', paddingVertical: 4, fontStyle: 'italic' },
